...
const testimonials: Testimonial[] = [
  {
    ...
    role: 'Paciente',
    content:
      'Testimonial placeholder - La atención personalizada y el seguimiento constante me ayudaron a mejorar mi salud.',
    rating: 5,
  },
  {
    id: 'testimonial-2',
    ...
    role: 'Paciente',
    content:
      'Testimonial placeholder - Excelente profesional, muy recomendada para consultas nutricionales.',
    rating: 5,
  },
  {
    id: 'testimonial-3',
    ...
    role: 'Paciente',
    content:
      'Testimonial placeholder - Consultas online muy efectivas, me encanta el seguimiento por WhatsApp.',
    rating: 5,
  },
];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="nutrición clínica, Santa Rosa de Copán, consultas online, nutricionista Honduras"
        />
        ...
        <meta
          ...
          content="Consultas nutricionales en Santa Rosa de Copán y online."
        />
      </Helmet>
      ...
      <main>
        ...
        <Benefits title="¿Por qué elegir NutriBianca?" benefits={benefits} />

        <Process title="Nuestro proceso de consulta" steps={processSteps} />

        <Testimonials title="Lo que dicen nuestros pacientes" testimonials={testimonials} />
      </main>
    </>
  );
};
